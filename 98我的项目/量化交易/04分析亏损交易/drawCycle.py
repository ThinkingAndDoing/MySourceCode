...
if __name__=="__main__":
    ...
    print(df[colname])    
    plt.scatter(list(df.index.values).index("20180102 07:21:00"), df.loc["20180102 07:21:00"]["<CLOSE>"], marker='o', c='', edgecolors='r')
    plt.scatter(list(df.index.values).index("20180102 07:41:00"), df.loc["20180102 07:41:00"]["<CLOSE>"], marker='o', c='', edgecolors='r')
    plt.show()
