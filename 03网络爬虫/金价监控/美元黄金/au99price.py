...
class AuPrice:
	...
	def getHistoryUrl(self, num):
		...
		'''
		return "http://vip.stock.finance.sina.com.cn/q/view/vFutures_History.php?page="+str(num)+"&breed=XAU&start="+self.startDate+"&end="+self.endDate+"&jys=LIFFE&pz=XAU&hy=&type=global&name=%B4%F3%B6%B91109"
