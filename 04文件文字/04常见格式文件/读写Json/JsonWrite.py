...
_ImgPathList = {
    "_ListImgPath": [
        [
            ".\\..\\..\\GraphicalResources\\Bitmaps\\Bitmaps\\Warning\\Telltales\\",
            ".\\Bitmaps\\Warning\\Telltales\\",
            "Telltale_",
        ],
        [
            ".\\..\\..\\GraphicalResources\\Bitmaps\\Bitmaps\\Warning\\DoorOpen\\",
            ".\\Bitmaps\\Warning\\DoorOpen\\",
            "DoorOpen_",
        ],
        [
            ".\\..\\..\\GraphicalResources\\Bitmaps\\Bitmaps\\Warning\\Message\\",
            ".\\Bitmaps\\Warning\\Message\\",
            "Message_",
        ],
    ]
}
...
_WrnObjConf = {
    "TelltaleP14ExtensionSupportType[]": ["TelltalesP14", "1", "No"],
    "WarningExtensionSupportType[]": [
        "Warnings",
        "3",
        "Yes",
        "ID",
...
_WrnDispatConf = {
    "DispatcherName": "GE_FE_7DA_5DB_Display",
    "WarningStrategy": {
        "WSTT1Pos": ["InsertReversePrioAndSubprio", "SelectCustom"],
